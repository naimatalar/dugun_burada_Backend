        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneConfirmCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FirmUserLaboteUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FirmUserLaboteUsers_AspNetUsers_LaboteUserId",
                        column: x => x.LaboteUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FirmUserLaboteUsers_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FirmUserLaboteUsers_CompanyId",
                table: "FirmUserLaboteUsers",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_FirmUserLaboteUsers_LaboteUserId",
                table: "FirmUserLaboteUsers",
                column: "LaboteUserId");
