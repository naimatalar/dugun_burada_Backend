...
namespace Labote.Core.Migrations
{
    ...
    [Migration("20230124142952_mmgmdsfkgds")]
    partial class mmgmdsfkgds
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Labote.Core.Entities.DiscountCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("DiscountCompanies");
                });

            modelBuilder.Entity("Labote.Core.Entities.IndexCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Labote.Core.Entities.IndexCategoryCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("IndexCategoryCompany");
                });
            ...
            modelBuilder.Entity("Labote.Core.Entities.SelectedCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SelectedCompanies");
                });

            modelBuilder.Entity("Labote.Core.Entities.SelectedCompanyTypeCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SelectedCompanyTypeCompanies");
                });
            ...
            modelBuilder.Entity("Labote.Core.Entities.IndexCategoryCompany", b =>
                {
                    b.HasOne("Labote.Core.Entities.Company", "Company")
                        .WithMany("IndexCategoryCompanies")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Labote.Core.Entities.SelectedCompanyTypeCompany", b =>
                {
                    b.HasOne("Labote.Core.Entities.Company", "Company")
                        .WithMany("SelectedCompanyTypeCompanes")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Labote.Core.Entities.Company", b =>
                {
                    ...
                    b.Navigation("DiscountCompanies");

                    b.Navigation("Faqs");

                    b.Navigation("FirmUserLaboteUsers");

                    b.Navigation("IndexCategoryCompanies");

                    b.Navigation("PropertySelectListValues");

                    b.Navigation("SelectedCompanyTypeCompanes");
                });
